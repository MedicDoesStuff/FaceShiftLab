...
""").lower()
        ...
        with tf.device (models_opt_device):
            if 'df' in archi_type:
                ...
                if self.options['scale'] == 0 and not self.options['grow']:
                    ...
                    self.encoder_prev = model_archi.FromRgb1(in_ch=input_ch, e_ch=e_dims, name='from_rgb_1')
                    self.encoder_block_0 = model_archi.EncoderBlock0(e_ch=e_dims, name='encoder_block_0')
                    self.encoder_block_1 = model_archi.EncoderBlock1(e_ch=e_dims, name='encoder_block_1')
                    self.encoder = model_archi.FromRgb2(in_ch=input_ch, e_ch=e_dims, name='from_rgb_2')
                    self.model_filename_list += [[self.encoder_prev, 'from_rgb_1.npy'],
                                                 [self.encoder_block_0, 'encoder_block_0'],
                                                 [self.encoder_block_1, 'encoder_block_1'],
                                                 [self.encoder, 'from_rgb_2.npy']]
                elif self.options['scale'] == 2 and not self.options['grow']:
                    self.encoder_block_0 = model_archi.EncoderBlock0(e_ch=e_dims, name='encoder_block_0')
                    self.encoder_block_1 = model_archi.EncoderBlock1(e_ch=e_dims, name='encoder_block_1')
                    self.encoder = model_archi.FromRgb2(in_ch=input_ch, e_ch=e_dims, name='from_rgb_2')
                    self.model_filename_list += [[self.encoder_block_0, 'encoder_block_0'],
                                                 [self.encoder_block_1, 'encoder_block_1'],
                                                 [self.encoder, 'from_rgb_2.npy']]
                elif self.options['scale'] == 2 and self.options['grow']:
                    self.encoder_prev = model_archi.FromRgb2(in_ch=input_ch, e_ch=e_dims, name='from_rgb_2')
                    self.encoder_block_0 = model_archi.EncoderBlock0(e_ch=e_dims, name='encoder_block_0')
                    self.encoder_block_1 = model_archi.EncoderBlock1(e_ch=e_dims, name='encoder_block_1')
                    self.encoder_block_2 = model_archi.EncoderBlock2(e_ch=e_dims, name='encoder_block_2')
                    self.encoder = model_archi.FromRgb3(in_ch=input_ch, e_ch=e_dims, name='from_rgb_3')
                    self.model_filename_list += [[self.encoder_prev, 'from_rgb_2.npy'],
                                                 [self.encoder_block_0, 'encoder_block_0'],
                                                 [self.encoder_block_1, 'encoder_block_1'],
                    ...
                    self.model_filename_list += [[self.encoder_block_0, 'encoder_block_0'],
                                                 ...
                                                 [self.encoder_block_3, 'encoder_block_3'],
                                                 [self.encoder, 'from_rgb_4.npy']]
                elif self.options['scale'] == 4 and self.options['grow']:
                    self.encoder_prev = model_archi.FromRgb4(in_ch=input_ch, e_ch=e_dims, name='from_rgb_4')
                    self.encoder_block_0 = model_archi.EncoderBlock0(e_ch=e_dims, name='encoder_block_0')
                    self.encoder_block_1 = model_archi.EncoderBlock1(e_ch=e_dims, name='encoder_block_1')
                    self.encoder_block_2 = model_archi.EncoderBlock2(e_ch=e_dims, name='encoder_block_2')
                    self.encoder_block_3 = model_archi.EncoderBlock3(e_ch=e_dims, name='encoder_block_3')
                    self.encoder_block_4 = model_archi.EncoderBlock4(e_ch=e_dims, name='encoder_block_4')
                    self.encoder = model_archi.FromRgb5(in_ch=input_ch, e_ch=e_dims, name='from_rgb_5')
                    self.model_filename_list += [[self.encoder_prev, 'from_rgb_4.npy'],
                                                 [self.encoder_block_0, 'encoder_block_0'],
                                                 [self.encoder_block_1, 'encoder_block_1'],
                                                 [self.encoder_block_2, 'encoder_block_2'],
                                                 [self.encoder_block_3, 'encoder_block_3'],
                                                 [self.encoder_block_4, 'encoder_block_4'],
                                                 [self.encoder, 'from_rgb_5.npy']]
                elif self.options['scale'] == 5 and not self.options['grow']:
                    self.encoder_block_0 = model_archi.EncoderBlock0(e_ch=e_dims, name='encoder_block_0')
                    self.encoder_block_1 = model_archi.EncoderBlock1(e_ch=e_dims, name='encoder_block_1')
                    self.encoder_block_2 = model_archi.EncoderBlock2(e_ch=e_dims, name='encoder_block_2')
                    self.encoder_block_3 = model_archi.EncoderBlock3(e_ch=e_dims, name='encoder_block_3')
                ...
                if self.options['scale'] == 0 and not self.options['grow']:
                    ...
                    self.model_filename_list += [[self.decoder_prev, 'to_rgb_1.npy'],
                                                 ...
                                                 [self.decoder, 'to_rgb_2.npy'],
                                                 [self.decoder_mask, 'to_mask_2.npy']]
                elif self.options['scale'] == 2 and not self.options['grow']:
                    self.decoder_block_0 = model_archi.DecoderBlock0(in_ch=inters_out_ch, d_ch=d_dims, d_mask_ch=d_mask_dims, name='decoder_block_0')
                    self.decoder_block_1 = model_archi.DecoderBlock1(d_ch=d_dims, name='decoder_block_1')
                    self.decoder_mask_block_1 = model_archi.DecoderMaskBlock1(d_mask_ch=d_mask_dims, name='decoder_mask_block_1')
                    ...
                    self.decoder_prev = model_archi.ToRgb2(in_ch=d_dims*4, name='to_rgb_2')
                    self.decoder_mask_prev = model_archi.ToMask2(in_ch_m=d_mask_dims*4, name='to_mask_2')
                    self.decoder_block_0 = model_archi.DecoderBlock0(in_ch=inters_out_ch, d_ch=d_dims, d_mask_ch=d_mask_dims, name='decoder_block_0')
                    self.decoder_block_1 = model_archi.DecoderBlock1(d_ch=d_dims, name='decoder_block_1')
                    self.decoder_mask_block_1 = model_archi.DecoderMaskBlock1(d_mask_ch=d_mask_dims, name='decoder_mask_block_1')
                    ...
                    self.decoder = model_archi.ToRgb3(in_ch=d_dims*2, name='to_rgb_3')
                    self.decoder_mask = model_archi.ToMask3(in_ch_m=d_mask_dims*2, name='to_mask_3')
                    self.model_filename_list += [[self.decoder_prev, 'to_rgb_2.npy'],
                                                 [self.decoder_mask_prev, 'to_mask_2.npy'],
                                                 [self.decoder_block_0, 'decoder_block_0.npy'],
                                                 [self.decoder_block_1, 'decoder_block_1.npy'],
                                                 [self.decoder_mask_block_1, 'decoder_mask_block_1.npy'],
                    ...
                    self.decoder_prev = model_archi.ToRgb4(in_ch=d_dims, name='to_rgb_4')
                    self.decoder_mask_prev = model_archi.ToMask4(in_ch_m=d_mask_dims, name='to_mask_4')
                    self.decoder_block_0 = model_archi.DecoderBlock0(in_ch=inters_out_ch, d_ch=d_dims, d_mask_ch=d_mask_dims, name='decoder_block_0')
                    self.decoder_block_1 = model_archi.DecoderBlock1(d_ch=d_dims, name='decoder_block_1')
                    self.decoder_mask_block_1 = model_archi.DecoderMaskBlock1(d_mask_ch=d_mask_dims, name='decoder_mask_block_1')
                    self.decoder_block_2 = model_archi.DecoderBlock2(d_ch=d_dims, name='decoder_block_2')
                    ...
                    self.model_filename_list += [[self.decoder_prev, 'to_rgb_4.npy'],
                                                 ...
                                                 [self.decoder_block_3, 'decoder_block_3.npy'],
                                                 [self.decoder_mask_block_3, 'decoder_mask_block_3.npy'],
                                                 [self.decoder_block_4, 'decoder_block_4.npy'],
                                                 [self.decoder_mask_block_4, 'decoder_mask_block_4.npy'],
                                                 [self.decoder, 'to_rgb_5.npy'],
                                                 [self.decoder_mask, 'to_mask_5.npy']]
                elif self.options['scale'] == 5 and not self.options['grow']:
                    self.decoder_block_0 = model_archi.DecoderBlock0(in_ch=inters_out_ch, d_ch=d_dims, d_mask_ch=d_mask_dims, name='decoder_block_0')
                    self.decoder_block_1 = model_archi.DecoderBlock1(d_ch=d_dims, name='decoder_block_1')
                    self.decoder_mask_block_1 = model_archi.DecoderMaskBlock1(d_mask_ch=d_mask_dims, name='decoder_mask_block_1')
                ...
                if 'df' in archi_type:
                    ...
                    if self.options['scale'] == 0 and not self.options['grow']:
                        ...
                        self.src_dst_trainable_weights = self.encoder_prev.get_weights() \
                                                         ...
                                                         + self.encoder_block_2.get_weights() \
                                                         + self.encoder_block_3.get_weights() \
                                                         + self.encoder_block_4.get_weights() \
                                                         + self.encoder.get_weights() \
                                                         + self.inter_AB.get_weights() \
                                                         + self.inter_B.get_weights() \
                                                         + self.decoder_prev.get_weights() \
                                                         ...
                                                         + self.decoder_block_3.get_weights() \
                                                         + self.decoder_mask_block_3.get_weights() \
                                                         + self.decoder_block_4.get_weights() \
                                                         + self.decoder_mask_block_4.get_weights() \
                                                         + self.decoder.get_weights() \
                                                         + self.decoder_mask.get_weights()
                    elif self.options['scale'] == 5 and not self.options['grow']:
                        self.src_dst_trainable_weights = self.encoder_block_0.get_weights() \
                ...
                with tf.device( f'/GPU:{gpu_id}' if len(devices) != 0 else f'/CPU:0' ):
                    ...
                    if 'df' in archi_type:
                        ...
                        if self.options['scale'] == 0 and not self.options['grow']:
                            ...
                            gpu_src_code_prev = self.encoder_block_0(self.encoder_prev(nn.resize2d_area(gpu_warped_src, size=-2)))
                            gpu_src_code_next = self.encoder_block_0(self.encoder_block_1(self.encoder(gpu_warped_src)))
                            gpu_src_code = self.alpha * gpu_src_code_next + (1 - self.alpha) * gpu_src_code_prev

                            gpu_dst_code_prev = self.encoder_block_0(self.encoder_prev(nn.resize2d_area(gpu_warped_dst, size=-2)))
                            gpu_dst_code_next = self.encoder_block_0(self.encoder_block_1(self.encoder(gpu_warped_dst)))
                            gpu_dst_code = self.alpha * gpu_dst_code_next + (1 - self.alpha) * gpu_dst_code_prev
                        elif self.options['scale'] == 2 and not self.options['grow']:
                            gpu_src_code = self.encoder_block_0(self.encoder_block_1(self.encoder(gpu_warped_src)))
                            gpu_dst_code = self.encoder_block_0(self.encoder_block_1(self.encoder(gpu_warped_dst)))
                        elif self.options['scale'] == 2 and self.options['grow']:
                            gpu_src_code_prev = self.encoder_block_0(self.encoder_block_1(self.encoder_prev(nn.resize2d_area(gpu_warped_src, size=-2))))
                            gpu_src_code_next = self.encoder_block_0(self.encoder_block_1(self.encoder_block_2(self.encoder(gpu_warped_src))))
                            gpu_src_code = self.alpha * gpu_src_code_next + (1 - self.alpha) * gpu_src_code_prev

                            gpu_dst_code_prev = self.encoder_block_0(self.encoder_block_1(self.encoder_prev(nn.resize2d_area(gpu_warped_dst, size=-2))))
                            gpu_dst_code_next = self.encoder_block_0(self.encoder_block_1(self.encoder_block_2(self.encoder(gpu_warped_dst))))
                            gpu_dst_code = self.alpha * gpu_dst_code_next + (1 - self.alpha) * gpu_dst_code_prev
                        elif self.options['scale'] == 3 and not self.options['grow']:
                            ...
                            gpu_src_code_prev = self.encoder_block_0(self.encoder_block_1(self.encoder_block_2(self.encoder_block_3(self.encoder_prev(nn.resize2d_area(gpu_warped_src, size=-2))))))
                            gpu_src_code_next = self.encoder_block_0(self.encoder_block_1(self.encoder_block_2(self.encoder_block_3(self.encoder_block_4(self.encoder(gpu_warped_src))))))
                            gpu_src_code = self.alpha * gpu_src_code_next + (1 - self.alpha) * gpu_src_code_prev

                            gpu_dst_code_prev = self.encoder_block_0(self.encoder_block_1(self.encoder_block_2(self.encoder_block_3(self.encoder_prev(nn.resize2d_area(gpu_warped_dst, size=-2))))))
                            gpu_dst_code_next = self.encoder_block_0(self.encoder_block_1(self.encoder_block_2(self.encoder_block_3(self.encoder_block_4(self.encoder(gpu_warped_dst))))))
                            gpu_dst_code = self.alpha * gpu_dst_code_next + (1 - self.alpha) * gpu_dst_code_prev
                        elif self.options['scale'] == 5 and not self.options['grow']:
                            gpu_src_code = self.encoder_block_0(self.encoder_block_1(self.encoder_block_2(self.encoder_block_3(self.encoder_block_4(self.encoder(gpu_warped_src))))))
                            gpu_dst_code = self.encoder_block_0(self.encoder_block_1(self.encoder_block_2(self.encoder_block_3(self.encoder_block_4(self.encoder(gpu_warped_dst))))))
                        ...
                        if self.options['scale'] == 0 and not self.options['grow']:
                            ...
                            x, m = self.decoder_block_0(gpu_src_code)
                            gpu_pred_src_src_prev = self.decoder_prev(x)
                            gpu_pred_src_srcm_prev = self.decoder_mask_prev(m)
                            x, m = self.decoder_block_0(gpu_dst_code)
                            gpu_pred_dst_dst_prev = self.decoder_prev(x)
                            gpu_pred_dst_dstm_prev = self.decoder_mask_prev(m)
                            x, m = self.decoder_block_0(gpu_src_dst_code)
                            gpu_pred_src_dst_prev = self.decoder_prev(x)
                            gpu_pred_src_dstm_prev = self.decoder_mask_prev(m)
                            ...
                            x, m = self.decoder_block_0(gpu_src_code)
                            gpu_pred_src_src_next = self.decoder(self.decoder_block_1(x))
                            gpu_pred_src_srcm_next = self.decoder_mask(self.decoder_mask_block_1(m))
                            x, m = self.decoder_block_0(gpu_dst_code)
                            gpu_pred_dst_dst_next = self.decoder(self.decoder_block_1(x))
                            gpu_pred_dst_dstm_next = self.decoder_mask(self.decoder_mask_block_1(m))
                            x, m = self.decoder_block_0(gpu_src_dst_code)
                            gpu_pred_src_dst_next = self.decoder(self.decoder_block_1(x))
                            gpu_pred_src_dstm_next = self.decoder_mask(self.decoder_mask_block_1(m))
                            ...
                            x, m = self.decoder_block_0(gpu_src_code)
                            gpu_pred_src_src = self.decoder(self.decoder_block_1(x))
                            gpu_pred_src_srcm = self.decoder_mask(self.decoder_mask_block_1(m))
                            x, m = self.decoder_block_0(gpu_dst_code)
                            gpu_pred_dst_dst = self.decoder(self.decoder_block_1(x))
                            gpu_pred_dst_dstm = self.decoder_mask(self.decoder_mask_block_1(m))
                            x, m = self.decoder_block_0(gpu_src_dst_code)
                            gpu_pred_src_dst = self.decoder(self.decoder_block_1(x))
                            gpu_pred_src_dstm = self.decoder_mask(self.decoder_mask_block_1(m))
                        elif self.options['scale'] == 2 and self.options['grow']:
                            x, m = self.decoder_block_0(gpu_src_code)
                            gpu_pred_src_src_prev = self.decoder_prev(self.decoder_block_1(x))
                            gpu_pred_src_srcm_prev = self.decoder_mask_prev(self.decoder_mask_block_1(m))
                            x, m = self.decoder_block_0(gpu_dst_code)
                            gpu_pred_dst_dst_prev = self.decoder_prev(self.decoder_block_1(x))
                            gpu_pred_dst_dstm_prev = self.decoder_mask_prev(self.decoder_mask_block_1(m))
                            x, m = self.decoder_block_0(gpu_src_dst_code)
                            gpu_pred_src_dst_prev = self.decoder_prev(self.decoder_block_1(x))
                            gpu_pred_src_dstm_prev = self.decoder_mask_prev(self.decoder_mask_block_1(m))
                            ...
                            x, m = self.decoder_block_0(gpu_src_code)
                            gpu_pred_src_src_next = self.decoder(self.decoder_block_2(self.decoder_block_1(x)))
                            gpu_pred_src_srcm_next = self.decoder_mask(self.decoder_mask_block_2(self.decoder_mask_block_1(m)))
                            x, m = self.decoder_block_0(gpu_dst_code)
                            gpu_pred_dst_dst_next = self.decoder(self.decoder_block_2(self.decoder_block_1(x)))
                            gpu_pred_dst_dstm_next = self.decoder_mask(self.decoder_mask_block_2(self.decoder_mask_block_1(m)))
                            x, m = self.decoder_block_0(gpu_src_dst_code)
                            gpu_pred_src_dst_next = self.decoder(self.decoder_block_2(self.decoder_block_1(x)))
                            gpu_pred_src_dstm_next = self.decoder_mask(self.decoder_mask_block_2(self.decoder_mask_block_1(m)))
                            ...
                            x, m = self.decoder_block_0(gpu_src_code)
                            gpu_pred_src_src = self.decoder(self.decoder_block_2(self.decoder_block_1(x)))
                            gpu_pred_src_srcm = self.decoder_mask(self.decoder_mask_block_2(self.decoder_mask_block_1(m)))
                            x, m = self.decoder_block_0(gpu_dst_code)
                            gpu_pred_dst_dst = self.decoder(self.decoder_block_2(self.decoder_block_1(x)))
                            gpu_pred_dst_dstm = self.decoder_mask(self.decoder_mask_block_2(self.decoder_mask_block_1(m)))
                            x, m = self.decoder_block_0(gpu_src_dst_code)
                            ...
                            x, m = self.decoder_block_0(gpu_src_code)
                            gpu_pred_src_src_prev = self.decoder_prev(self.decoder_block_3(self.decoder_block_2(self.decoder_block_1(x))))
                            gpu_pred_src_srcm_prev = self.decoder_mask_prev(self.decoder_mask_block_3(self.decoder_mask_block_2(self.decoder_mask_block_1(m))))
                            x, m = self.decoder_block_0(gpu_dst_code)
                            gpu_pred_dst_dst_prev = self.decoder_prev(self.decoder_block_3(self.decoder_block_2(self.decoder_block_1(x))))
                            gpu_pred_dst_dstm_prev = self.decoder_mask_prev(self.decoder_mask_block_3(self.decoder_mask_block_2(self.decoder_mask_block_1(m))))
                            x, m = self.decoder_block_0(gpu_src_dst_code)
                            gpu_pred_src_dst_prev = self.decoder_prev(self.decoder_block_3(self.decoder_block_2(self.decoder_block_1(x))))
                            gpu_pred_src_dstm_prev = self.decoder_mask_prev(self.decoder_mask_block_3(self.decoder_mask_block_2(self.decoder_mask_block_1(m))))
                            ...
                            x, m = self.decoder_block_0(gpu_src_code)
                            gpu_pred_src_src_next = self.decoder(self.decoder_block_4(self.decoder_block_3(self.decoder_block_2(self.decoder_block_1(x)))))
                            gpu_pred_src_srcm_next = self.decoder_mask(self.decoder_mask_block_4(self.decoder_mask_block_3(self.decoder_mask_block_2(self.decoder_mask_block_1(m)))))
                            x, m = self.decoder_block_0(gpu_dst_code)
                            gpu_pred_dst_dst_next = self.decoder(self.decoder_block_4(self.decoder_block_3(self.decoder_block_2(self.decoder_block_1(x)))))
                            gpu_pred_dst_dstm_next = self.decoder_mask(self.decoder_mask_block_4(self.decoder_mask_block_3(self.decoder_mask_block_2(self.decoder_mask_block_1(m)))))
                            x, m = self.decoder_block_0(gpu_src_dst_code)
                            gpu_pred_src_dst_next = self.decoder(self.decoder_block_4(self.decoder_block_3(self.decoder_block_2(self.decoder_block_1(x)))))
                            gpu_pred_src_dstm_next = self.decoder_mask(self.decoder_mask_block_4(self.decoder_mask_block_3(self.decoder_mask_block_2(self.decoder_mask_block_1(m)))))
                            ...
                            x, m = self.decoder_block_0(gpu_src_code)
                            gpu_pred_src_src = self.decoder(self.decoder_block_4(self.decoder_block_3(self.decoder_block_2(self.decoder_block_1(x)))))
                            gpu_pred_src_srcm = self.decoder_mask(self.decoder_mask_block_4(self.decoder_mask_block_3(self.decoder_mask_block_2(self.decoder_mask_block_1(m)))))
                            x, m = self.decoder_block_0(gpu_dst_code)
                            gpu_pred_dst_dst = self.decoder(self.decoder_block_4(self.decoder_block_3(self.decoder_block_2(self.decoder_block_1(x)))))
                            gpu_pred_dst_dstm = self.decoder_mask(self.decoder_mask_block_4(self.decoder_mask_block_3(self.decoder_mask_block_2(self.decoder_mask_block_1(m)))))
                            x, m = self.decoder_block_0(gpu_src_dst_code)
                            gpu_pred_src_dst = self.decoder(self.decoder_block_4(self.decoder_block_3(self.decoder_block_2(self.decoder_block_1(x)))))
                            gpu_pred_src_dstm = self.decoder_mask(self.decoder_mask_block_4(self.decoder_mask_block_3(self.decoder_mask_block_2(self.decoder_mask_block_1(m)))))
                    ...
                    gaussian_weights = nn.get_gaussian_weights(bs_per_gpu, input_ch, resolution)
                    ...
                    gpu_src_loss += 400 * tf.reduce_mean ( tf.reduce_sum(gaussian_weights[-1, :, :, :, :] * tf.abs ( gpu_target_src_masked_opt - gpu_pred_src_src_masked_opt ), axis=[2, 3]), axis=[1])
                    ...
                    gpu_dst_loss += 400 * tf.reduce_mean ( tf.reduce_sum(gaussian_weights[-1, :, :, :, :] * tf.abs ( gpu_target_dst_masked_opt- gpu_pred_dst_dst_masked_opt ), axis=[2, 3]), axis=[1])
    ...
    def onTrainOneIter(self):
        ...
        src_loss, dst_loss = self.src_dst_train (warped_src, target_src, target_srcm, target_srcm_em, warped_dst, target_dst, target_dstm, target_dstm_em, self.grow_alpha)
        ...
        if len(self.last_src_samples_loss) >= bs*16:
            ...
            src_loss, dst_loss = self.src_dst_train (target_src, target_src, target_srcm, target_srcm_em, target_dst, target_dst, target_dstm, target_dstm_em, self.grow_alpha )
            self.last_src_samples_loss = []
            self.last_dst_samples_loss = []
        ...
        if self.gan_power != 0:
            self.D_src_dst_train (warped_src, target_src, target_srcm, target_srcm_em, warped_dst, target_dst, target_dstm, target_dstm_em, self.grow_alpha)
