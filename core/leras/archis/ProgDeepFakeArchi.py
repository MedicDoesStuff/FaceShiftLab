    ...
    def __init__(self, final_resolution, mod=None, opts=None):
        ...
        if mod is None:
            ...
            class EncoderBlock3(nn.ModelBase):
                ...
                def on_build(self):
                    self.down = Downscale(self.e_ch//2, self.e_ch, kernel_size=5)

                def forward(self, inp):
                    x = self.down(inp)
                    return x

            class EncoderBlock2(nn.ModelBase):
                def __init__(self, e_ch, **kwargs ):
                    self.e_ch = e_ch
                    super().__init__(**kwargs)

                def on_build(self):
                    self.down = Downscale(self.e_ch, self.e_ch*2, kernel_size=5)

                def forward(self, inp):
                    x = self.down(inp)
                    return x

            class EncoderBlock1(nn.ModelBase):
                def __init__(self, e_ch, **kwargs ):
                    self.e_ch = e_ch
                    super().__init__(**kwargs)

                def on_build(self):
                    self.down = Downscale(self.e_ch*2, self.e_ch*4, kernel_size=5)
            ...
            class EncoderBlock0(nn.ModelBase):
                ...
                def on_build(self):
                    self.down = Downscale(self.e_ch*4, self.e_ch*8, kernel_size=5)
            ...
            class DecoderBlock2(nn.ModelBase):
                def on_build(self, d_ch ):
            ...
            class DecoderBlock3(nn.ModelBase):
                def on_build(self, d_ch ):
                    self.upscale3 = Upscale(d_ch*2, d_ch, kernel_size=3)
                    self.res3 = ResidualBlock(d_ch, kernel_size=3)
            ...
            class DecoderMaskBlock2(nn.ModelBase):
                def on_build(self, d_mask_ch ):
                    self.upscalem2 = Upscale(d_mask_ch*4, d_mask_ch*2, kernel_size=3)

                def forward(self, inp):
                    m = self.upscalem2(inp)

                    return m

            class DecoderMaskBlock3(nn.ModelBase):
                def on_build(self, d_mask_ch ):
        ...
        self.DecoderBlock2 = DecoderBlock2
